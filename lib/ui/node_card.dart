...
class NodeCard extends StatelessWidget {
  ...
  Widget _buildCard(BuildContext context, GraphStore store) {
    ...
    // 选中态:多选集合内任一成员均显示 accent 光环(Shift 多选/框选/Package)
    ...
    return Listener(
      ...
      onPointerDown: cfg.isViewer
          ? (_) => callbacks.onActivateViewer(nodeId)
          : null,
      child: GestureDetector(
        behavior: HitTestBehavior.translucent,
        onTap: cfg.isViewer ? null : () => callbacks.onSelect(nodeId),
                ...
                Positioned(
                  ...
                  child: MouseRegion(
                    ...
                    child: Listener(
                      ...
                      onPointerDown: (_) =>
                          callbacks.onResizeStart?.call(nodeId),
                      child: Padding(

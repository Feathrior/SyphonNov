...
; Build: makensis install.nsi  ->  dist\SyphonNov-0.4.2-Setup.exe
Unicode True

!include "MUI2.nsh"

Name "SyphonNov"
OutFile "dist\SyphonNov-0.4.2-Setup.exe"
...
Section "Install" SEC_MAIN
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\SyphonNov" "DisplayVersion" "0.4.2"
